...
- **`copilot_market_rules.md`** — 37 tactical rules (DD, paradigm, charm, vanna, SVB, macro override, DD whiplash). Pre-market checklist. Session scores. Read EVERY session start.
...
## Real Trader Config (Mar 25)
- **MAX_CONCURRENT_PER_DIR = 1** (accounts ~$880, margin $687/MES, can't afford 2)
